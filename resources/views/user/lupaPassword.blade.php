...
<html lang="en">
<head>
	<title>Lupa Password | Abdul</title>
	<meta charset="UTF-8">
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-50 p-r-50 p-t-77 p-b-30">
				<form autocomplete="off" class="login100-form validate-form" method="POST" action="/user/lupaPassword/proses">
                    ...
                    <div class="wrap-input100 m-b-16">
                        <h5 style="display: block">Lupa Password</h5>
					</div>

                    <div class="wrap-input100 m-b-16">
                        <p style="display: block">Masukkan email anda!</p>
					</div>
